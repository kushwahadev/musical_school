    ...
    >
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
          ...
          pariatur, sequi magni dolor, beatae doloribus dignissimos sint
          temporibus maxime voluptatem aspernatur nesciunt. Nesciunt dolore
          recusandae magnam totam reiciendis laborum.
        </p>
        <div className="mt-4">
          <Link href={"/courses"}>
            <Button
